...
use crate::tokenization::hf_tokenizers::utils::iter::ResultShunt;
use crate::tokenization::hf_tokenizers::utils::parallelism::*;
use crate::tokenization::hf_tokenizers::utils::progress::{ProgressBar, ProgressStyle};
...
// Re-export wrappers
pub use crate::tokenization::hf_tokenizers::decoders::DecoderWrapper;
pub use crate::tokenization::hf_tokenizers::models::ModelWrapper;
pub use crate::tokenization::hf_tokenizers::normalizers::NormalizerWrapper;
pub use crate::tokenization::hf_tokenizers::pre_tokenizers::PreTokenizerWrapper;
pub use crate::tokenization::hf_tokenizers::processors::PostProcessorWrapper;
// And some other types
pub use crate::tokenization::hf_tokenizers::utils::iter::LinesWithEnding;
pub use crate::tokenization::hf_tokenizers::utils::padding::{pad_encodings, PaddingDirection, PaddingParams, PaddingStrategy};
pub use crate::tokenization::hf_tokenizers::utils::truncation::{truncate_encodings, TruncationParams, TruncationStrategy};
    ...
    D: Decoder,
{
    ...
    pub fn token_to_id(&self, token: &str) -> Option<u32> {
        self.added_vocabulary.token_to_id1(token, &self.model)
    }
