use crate::tokenization::hf_tokenizers::tokenizer::{NormalizedString, Normalizer, Result};
...
mod tests {
    use super::*;
    use crate::tokenization::hf_tokenizers::normalizer::NormalizedString;
    use crate::tokenization::hf_tokenizers::normalizers::Lowercase;
    use crate::tokenization::hf_tokenizers::normalizers::NFKD;
